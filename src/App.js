...
function RepititionExercise({exercise, setMenuScreen}) {
  ...
  return <div>
    ...
    <button onClick= {setMenuScreen} style= {{fontSize:"2em"}}>Return</button>
  </div>
}

function LapExercise({exercise, setMenuScreen}) {

  return <div>
    <p>{exercise.name}</p>
    <p>00:00:00</p>
    <p>Laps:</p>
    <button style= {{fontSize:"2em"}}>Start</button>
    <button style= {{fontSize:"2em"}}>Stop</button>
    <button style= {{fontSize:"2em"}}>Reset</button><br></br>
    <button onClick= {setMenuScreen} style= {{fontSize:"2em"}}>Return</button>
  </div>
}
...
let exerciseList = [
  ...
  {type: RUNNING_EXERCISE, name: "Running Laps"}
]
